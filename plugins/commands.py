...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            InlineKeyboardButton("Cʜᴀɴɴᴇʟ 🔈", url=f"https://t.me/linuxbotstg")
            ],[
            InlineKeyboardButton("Hᴇʟᴩ 🕸️", callback_data="help"),
            InlineKeyboardButton("Main Channel 🚀", url=f"https://t.me/linuxbotstg")
            ],[      

            InlineKeyboardButton("Aʙᴏᴜᴛ ✨", callback_data="about")
        ]]
        m = await message.reply_sticker("CAACAgUAAxkBAAELVAtlwjZoqViXNfIHn0jqKH3i00pxuwACmgADyJRkFCxl4eFc7yVqNAQ") 
        await asyncio.sleep(2)
